...
!function(t, e) {
    ...
    function ee(t, e) {
        ...
        t.arc(i + o - a.bottomRight, n + s - a.bottomRight, a.bottomRight, wt, 0, !0),
    ...
    function Ye(t, e, i) {
        const n = i.box,
            o = t.maxPadding;
        U(i.pos) || (i.size && (t[i.pos] -= i.size), i.size = i.horizontal ? n.height : n.width, t[i.pos] += i.size),
    ...
    function qe(t, e, i) {
        ...
        for (o = 0, s = t.length; o < s; ++o)
            a = t[o],
            r = a.box,
            a.horizontal ? (r.left = r.fullSize ? n.left : e.left, r.right = r.fullSize ? i.outerWidth - n.right : e.left + e.w, r.top = c, r.bottom = c + r.height, r.width = r.right - r.left, c = r.bottom) : (r.left = l, r.right = l + r.width, r.top = r.fullSize ? n.top : e.top, r.bottom = r.fullSize ? i.outerHeight - n.right : e.top + e.h, r.height = r.bottom - r.top, l = r.right);
        e.x = l,
        e.y = c
    }
    mt.set("layout", {
    ...
    var Ke = {
        ...
        update(t, e, i, n) {
            ...
            !function(t, e) {
                ...
                for (i = 0, n = t.length; i < n; ++i)
                    o = t[i],
                    o.horizontal ? (o.width = o.box.fullSize && e.availableWidth, o.height = e.hBoxMaxHeight) : (o.width = e.vBoxMaxWidth, o.height = o.box.fullSize && e.availableHeight)
            }(l.concat(c), d),
            Xe(r.fullSize, f, d),
            Xe(l, f, d),
            Xe(c, f, d) && Xe(l, f, d),
    ...
    function ri(t, i, n) {
        ...
        return r.observe(s), function(t, e) {
            oi.size || window.addEventListener("resize", ai),
            oi.set(t, e)
        }(t, a), r
    }
    function li(t, e, i) {
        ...
        "resize" === e && function(t) {
            oi.delete(t),
            oi.size || window.removeEventListener("resize", ai)
        }(t)
    }
    function ci(t, i, n) {
        const o = t.canvas,
    ...
    function Pi(t, e) {
        ...
        for (let t = 0; t < d; ++t) {
            const i = e[t],
                {[l]: n, [c]: s} = i;
            u = (i._stacks || (i._stacks = {}))[c] = Si(o, h, n),
            u[r] = s
        }
    }
    function Di(t, e) {
    ...
    function Ni(t, e, i) {
        ...
        if (!(i && (l = 1 === n ? Math.max(c - s, a - c) : 0 === e ? (t.getPixelForTick(1) - c) / 2 : (c - t.getPixelForTick(o - 1)) / 2, c += o < e ? l : -l, c < s - r || c > a + r)))
            return c
    }
    function Hi(t) {
    ...
    class Yi extends Ri {
        ...
        update(t, e, i)
        {
            ...
            o.display && (o.autoSkip || "auto" === o.source) && (n.ticks = zi(n, n.ticks), n._labelSizes = null),
        ...
        calculateLabelRotation()
        {
            ...
            d + 6 > a && (a = f / (n - (e.offset ? .5 : 1)), r = t.maxHeight - Hi(e.grid) - i.padding - ji(e.title, t.chart.options.font), l = Math.sqrt(d * d + u * u), c = Et(Math.min(Math.asin(Math.min((h.highest.height + 6) / a, 1)), Math.asin(Math.min(r / l, 1)) - Math.asin(u / l))), c = Math.max(o, Math.min(s, c))),
            t.labelRotation = c
        }
        ...
        fit()
        {
            ...
            t._handleMargins(),
            r ? (t.width = t._length = i.width - t._margins.left - t._margins.right, t.height = e.height) : (t.width = e.width, t.height = t._length = i.height - t._margins.top - t._margins.bottom)
        }
        _calculatePadding(t, e, i, n)
        {
            ...
            if (o.isHorizontal()) {
                ...
                let d = 0,
                    u = 0;
                l ? c ? (d = n * t.width, u = i * e.height) : (d = i * t.height, u = n * e.width) : "start" === s ? u = e.width : "end" === s ? d = t.width : (d = t.width / 2, u = e.width / 2),
        ...
        _computeGridLineItems(t)
        {
            ...
            for (x = 0; x < c; ++x) {
                ...
                b = Ni(e, x, r),
                void 0 !== b && (_ = Ut(n, b, i), l ? y = w = k = P = _ : v = M = S = D = _, d.push({
                    tx1: y,
                    ty1: v,
                    tx2: w,
                    ty2: M,
        ...
        _computeLabelItems(t)
        {
            ...
            for (x = 0, b = r.length; x < b; ++x) {
                ...
                const i = D / 2,
                    ...
                    l = t.textStrokeColor,
                    h = t.textStrokeWidth;
                a ? (v = k, C = "top" === o ? "near" === c || 0 !== p ? -D * P + P / 2 : "center" === c ? -A.highest.height / 2 - i * P + P : -A.highest.height + P / 2 : "near" === c || 0 !== p ? P / 2 : "center" === c ? A.highest.height / 2 - i * P : A.highest.height - D * P, d && (C *= -1)) : (w = k, C = (1 - D) * P / 2),
                m.push({
                    rotation: p,
                    label: y,
                    font: S,
        ...
        drawGrid(t)
        {
            ...
            if (a) {
                ...
                let n,
                    ...
                    l,
                    c;
                e.isHorizontal() ? (n = Ut(o, e.left, a) - a / 2, r = Ut(o, e.right, t) + t / 2, l = c = i) : (l = Ut(o, e.top, a) - a / 2, c = Ut(o, e.bottom, t) + t / 2, n = r = i),
                h({
                    x: n,
                    y: l
                }, {
    ...
    function cn(t) {
        ...
        !function(t, e, i) {
            ...
            for (let h = 0; h < n - 1; ++h)
                l = c,
                c = rn(t, h + 1),
                l && c && (At(e[h], 0, an) ? i[h] = i[h + 1] = 0 : (o = i[h] / e[h], s = i[h + 1] / e[h], r = Math.pow(o, 2) + Math.pow(s, 2), r <= 9 || (a = 3 / Math.sqrt(r), i[h] = o * a * e[h], i[h + 1] = s * a * e[h])))
        }(t, i, n),
        function(t, e) {
            const i = t.length;
            let n,
    ...
    function dn(t, e, i, n) {
        ...
        e.capBezierPoints && function(t, e) {
            ...
            for (i = 0, n = t.length; i < n; ++i)
                ...
                s = r,
                r = i < n - 1 && Kt(t[i + 1], e),
                s && (o = t[i], a && (o.cp1x = hn(o.cp1x, e.left, e.right), o.cp1y = hn(o.cp1y, e.top, e.bottom)), r && (o.cp2x = hn(o.cp2x, e.left, e.right), o.cp2y = hn(o.cp2y, e.top, e.bottom)))
        }(t, i)
    }
    function un(t, e, i, n) {
        return {
    ...
    function yn(t, e, i) {
        ...
        for (let t = h, i = h; t <= d; ++t)
            m = e[t % a],
            m.skip || (p = c(m[n]), b = l(p, o, s), null === _ && y() && (_ = 0 === r(p, o) ? t : i), null !== _ && v() && (g.push(_n({
                start: _,
                end: t,
                loop: u,
                count: a,
        ...
        return Mn(function(t, e, i, n) {
            ...
            for (a = e + 1; a <= i; ++a) {
                ...
                i.skip || i.stop ? l.skip || (n = !1, s.push({
                    ...
                    loop: n
                }), e = r = i.stop ? a : null) : (r = a, l.skip && (e = a)),
                l = i
            }
    ...
    function zn(t, e) {
        let i = In.get(t);
        return i || (i = e(), In.set(t, i), Fn.add(i)), i
    }
    const Vn = (t, e, i) => {
        const n = lt(e, i);
        void 0 !== n && t.add(n)
    ...
    class Bn {
        constructor(t)
        {
            this._config = function(t) {
                ...
                return e.datasets = e.datasets || [], e.labels = e.labels || [], En(t), t
            }(t),
        ...
        datasetScopeKeys(t)
        {
            return zn(t, (() => [["datasets." + t, ""]]))
        }
        datasetAnimationScopeKeys(t, e)
        {
            return zn(`${t}.transition.${e}`, (() => [[`datasets.${t}.transitions.${e}`, "transitions." + e], ["datasets." + t, ""]]))
        }
        datasetElementScopeKeys(t, e)
        {
            return zn(`${t}-${e}`, (() => [[`datasets.${t}.elements.${e}`, "datasets." + t, "elements." + e, ""]]))
        }
        pluginScopeKeys(t)
        {
            const e = t.id;
        ...
        getOptionScopes(t, e, i)
        {
            ...
            const r = new Set;
            e.forEach((e => {
                t && (r.add(t), e.forEach((e => Vn(r, t, e)))),
                e.forEach((t => Vn(r, n, t))),
                e.forEach((t => Vn(r, ut[o] || {}, t))),
                e.forEach((t => Vn(r, mt, t))),
                e.forEach((t => Vn(r, ft, t)))
            }));
            const l = [...r];
            return Fn.has(e) && s.set(e, l), l
        }
        chartOptionScopes()
        {
        ...
        resolveNamedOptions(t, e, i, n=[""])
        {
            const o = {
                ...
                {resolver: s, subPrefixes: a} = Wn(this._resolverCache, t, n);
            let r = s;
            if (function(t, e) {
        ...
        {
            const {resolver: o} = Wn(this._resolverCache, t, i);
    ...
    function Xn(t) {
        return Un() && "string" == typeof t ? t = document.getElementById(t) : t && t.length && (t = t[0]), t && t.canvas && (t = t.canvas), t
    }
    const qn = {},
        Kn = t => {
            const e = Xn(t);
            return Object.values(qn).filter((t => t.canvas === e)).pop()
        };
    class Gn {
        constructor(t, e)
        {
            const n = this;
            this.config = e = new Bn(e);
            const o = Xn(t),
                s = Kn(o);
            if (s)
            ...
            qn[n.id] = n,
            l && c ? (a.listen(n, "complete", $n), a.listen(n, "progress", Yn), n._initialize(), n.attached && n.update()) : console.error("Failed to create chart: can't acquire context from the given item")
        }
        get aspectRatio()
        {
        ...
        {
            return e.platform ? new e.platform : !Un() || "undefined" != typeof OffscreenCanvas && t instanceof OffscreenCanvas ? new Ze : new hi
        }
        clear()
        {
        ...
        buildOrUpdateScales()
        {
            ...
            J(s, (i => {
                const s = i.options,
                    ...
                    r = Ln(a, s),
                    l = K(s.type, i.dtype);
                void 0 !== s.position && Hn(s.position, r) === Hn(i.dposition) || (s.position = i.dposition),
                o[a] = !0;
                let c = null;
        ...
        _updateMetasets()
        {
            ...
            t._sortedMetasets = e.slice(0).sort(jn("order", "index"))
        }
        ...
        buildOrUpdateControllers()
        {
            ...
            for (t._removeUnreferencedMetasets(), n = 0, o = i.length; n < o; n++) {
                ...
                if (s.type && s.type !== a && (t._destroyDatasetMeta(n), s = t.getDatasetMeta(n)), s.type = a, s.indexAxis = o.indexAxis || Rn(a, t.options), s.order = o.order || 0, t._updateMetasetIndex(s, n), s.label = "" + o.label, s.visible = t.isDatasetVisible(n), s.controller)
        ...
        render()
        {
            ...
            !1 !== t.notifyPlugins("beforeRender", {
                cancelable: !0
            }) && (a.has(t) ? t.attached && !a.running(t) && a.start(t) : (t.draw(), $n({
                chart: t
            })))
        }
        draw()
        {
            ...
            if (t.clear(), t.width <= 0 || t.height <= 0)
                return;
        ...
        _eventHandler(t, e)
        {
            ...
            if (!1 === i.notifyPlugins("beforeEvent", n, o))
                return;
    ...
    const Zn = () => J(Gn.instances, (t => t._plugins.invalidate())),
        Qn = !0;
    function Jn() {
    ...
    function io(t) {
        ...
        for (i = 0, n = e.length; i < n; ++i)
            ...
            r();
        for (i = 0, n = t.ticks.length; i < n; ++i)
    ...
    class ao extends Ti {
        ...
        getLabelAndValue(t)
        {
            const e = this._cachedMeta,
                ...
                o = this.getParsed(t),
                s = o._custom,
                a = so(s) ? "[" + s.start + ", " + s.end + "]" : "" + n.getLabelForValue(o[n.axis]);
            return {
        ...
        update(t)
        {
            ...
            let {start: r, count: l} = function(t, e, i) {
                ...
                if (t._sorted) {
                    ...
                    d && (o = Nt(Math.min(ne(r, a.axis, c).lo, i ? n : ne(e, l, a.getPixelForValue(c)).lo), 0, n - 1)),
                    s = u ? Nt(Math.max(ne(r, a.axis, h).hi + 1, i ? 0 : ne(e, l, a.getPixelForValue(h)).hi + 1), o, n) - o : n - o
                }
                return {
                    start: o,
                    count: s
    ...
    var po = Object.freeze({
        ...
        BarController: ao,
        BubbleController: ro,
        DoughnutController: lo,
        LineController: co,
        PolarAreaController: ho,
        PieController: uo,
        RadarController: fo,
        ScatterController: go
    });
    function mo(t, e) {
        ...
        t.beginPath(),
        t.arc(s, a, r, i - c, n + c),
        l > o ? (c = o / l, t.arc(s, a, l, n + c, i - c, !0)) : t.arc(s, a, o, n + wt, i - wt),
        t.closePath(),
        t.clip()
    }
    function xo(t, e, i, n) {
    ...
    function _o(t, e) {
        const {x: i, y: n, startAngle: o, endAngle: s, pixelMargin: a} = e,
            ...
            l = e.innerRadius + a,
            {outerStart: c, outerEnd: h, innerStart: d, innerEnd: u} = xo(e, l, r, s - o),
            f = r - c,
            g = r - h,
            p = o + c / f,
            m = s - h / g,
    ...
    function yo(t, e) {
        ...
        i.borderWidth && (n ? (t.lineWidth = 2 * i.borderWidth, t.lineJoin = "round") : (t.lineWidth = i.borderWidth, t.lineJoin = "bevel"), e.fullCircles && function(t, e, i) {
            const {x: n, y: o, startAngle: s, endAngle: a, pixelMargin: r} = e,
                ...
                c = e.innerRadius + r;
            let h;
            for (i && (e.endAngle = e.startAngle + bt, mo(t, e), e.endAngle = a, e.endAngle === e.startAngle && (e.endAngle += bt, e.fullCircles--)), t.beginPath(), t.arc(n, o, c, s + bt, s, !0), h = 0; h < e.fullCircles; ++h)
                t.stroke();
            for (t.beginPath(), t.arc(n, o, l, s, s + bt), h = 0; h < e.fullCircles; ++h)
                t.stroke()
        }(t, e, n), n && mo(t, e), _o(t, e), t.stroke())
    }
    class vo extends Ri {
        constructor(t)
        {
    ...
    function So(t, e, i, n) {
        const {points: o, options: s} = e,
            {count: a, start: r, loop: l, ilen: c} = ko(o, i, n),
            h = function(t) {
                return t.stepped ? Qt : t.tension ? Jt : Mo
            }(s);
        let d,
            u,
            f,
    ...
    function Po(t, e, i, n) {
        const o = e.points,
            {count: s, start: a, ilen: r} = ko(o, i, n),
    ...
    function Do(t) {
        ...
        return !(t._decimated || t._loop || e.tension || e.stepped || i) ? Po : So
    }
    vo.id = "arc",
    vo.defaults = {
        borderAlign: "center",
    ...
    const Co = "function" == typeof Path2D;
    function Oo(t, e, i, n) {
        Co && 1 === e.segments.length ? function(t, e, i, n) {
            let o = e._path;
    ...
    class Ao extends Ri {
        ...
        draw(t, e, i, n)
        {
            const o = this,
                s = o.options || {};
            (o.points || []).length && s.borderWidth && (t.save(), Oo(t, o, i, n), t.restore(), o.animated && (o._pointsUpdated = !1, o._path = void 0))
        }
    }
    function To(t, e, i, n) {
        const o = t.options,
    ...
    function Eo(t) {
        ...
        const i = {};
        return e ? (e = t.horizontal ? Io(e, "left", "right", t.base > t.x) : Io(e, "bottom", "top", t.base < t.y), i[e] = !0, i) : i
    }
    function Io(t, e, i, n) {
        var o,
            s,
            a;
        return n ? (a = i, t = Fo(t = (o = t) === (s = e) ? a : o === a ? s : o, i, e)) : t = Fo(t, e, i), t
    }
    function Fo(t, e, i) {
        ...
        const e = Lo(t),
            ...
            o = function(t, e, i) {
                const n = t.options.borderWidth,
                    ...
                    s = Le(n);
                return {
                    t: zo(o.top, s.top, 0, i),
                    r: zo(o.right, s.right, 0, e),
                    b: zo(o.bottom, s.bottom, 0, i),
                    l: zo(o.left, s.left, 0, e)
                }
            }(t, i / 2, n / 2),
            s = function(t, e, i) {
                const n = Ee(t.options.borderRadius),
                    ...
                    s = Eo(t);
                return {
                    topLeft: zo(s.top || s.left, n.topLeft, 0, o),
                    topRight: zo(s.top || s.right, n.topRight, 0, o),
                    bottomLeft: zo(s.bottom || s.left, n.bottomLeft, 0, o),
                    bottomRight: zo(s.bottom || s.right, n.bottomRight, 0, o)
                }
            }(t, i / 2, n / 2);
        return {
            outer: {
    ...
    class No extends Ri {
        ...
        draw(t)
        {
            const e = this.options,
                {inner: i, outer: n} = Vo(this),
                o = (s = n.radius).topLeft || s.topRight || s.bottomLeft || s.bottomRight ? ee : Wo;
            var s;
            t.save(),
                ...
                let h,
                    {start: d, count: u} = function(t, e) {
                        ...
                        let n,
                            o = 0;
                        const {iScale: s} = t,
                            {min: a, max: r, minDefined: l, maxDefined: c} = s.getUserBounds();
                        ...
                        h = function(t, e, i, n, o) {
                            ...
                            for (a[l++] = t[p], h = 0; h < s - 2; h++) {
                                ...
                                const b = Math.floor(h * r) + 1 + e,
                                    ...
                                    {x: y, y: v} = t[p];
                                for (u = f = -1, n = b; n < _; n++)
                                    f = .5 * Math.abs((y - o) * (t[n].y - v) - (y - t[n].x) * (s - v)),
                                    f > u && (u = f, d = t[n], g = n);
                                a[l++] = d,
                                p = g
                            }
    ...
    function Xo(t) {
        return (t.scale || {}).getPointPositionForValue ? function(t) {
            ...
            if (h = "start" === i ? a : "end" === i ? r : U(i) ? i.value : e.getBaseValue(), n.grid.circular)
                return c = e.getPointPositionForValue(0, a), new Uo({
                    x: c.x,
                    y: c.y,
    ...
    const Ko = t => "line" === t.type && !t.hidden;
    function Go(t, e, i) {
        const n = [];
        for (let o = 0; o < i.length; o++) {
            const s = i[o],
                {first: a, last: r, point: l} = Zo(s, e, "x");
            if (!(!l || a && r))
                if (a)
                    n.unshift(l);
                else if (t.push(l), !r)
        ...
        const {line: i, target: n, property: o, color: s, scale: a} = e,
            r = function(t, e, i) {
                const n = t.segments,
                    ...
                    a = [];
                for (const t of n) {
                    const n = es(i, o[t.start], o[t.end], t.loop);
                    if (!e.segments) {
                        a.push({
                            source: t,
                            target: n,
                    ...
                    const r = vn(e, n);
                    for (const e of r) {
                        const r = es(i, s[e.start], s[e.end], e.loop),
                            l = yn(t, o, r);
                        for (const t of l)
                            a.push({
                                source: t,
                                target: e,
                                start: {
                                    [i]: is(n, r, "start", Math.max)
                                },
                                end: {
                                    [i]: is(n, r, "end", Math.min)
                                }
                            })
                    }
                }
    ...
    function as(t, e, i) {
        const n = function(t) {
                ...
                if ("stack" === i)
                    return qo(t);
                const o = Xo(t);
                return o instanceof Uo ? o : Qo(o, n)
            }(e),
            {line: o, scale: s} = e,
            a = o.options,
            r = a.fill,
            l = a.backgroundColor,
            {above: c=l, below: h=l} = r || {};
        n && o.points.length && (Gt(t, i), function(t, e) {
            const {line: i, target: n, above: o, below: s, area: a, scale: r} = e,
                l = i._loop ? "angle" : "x";
            t.save(),
            "x" === l && s !== o && (ts(t, n, a.top), ss(t, {
                line: i,
                target: n,
                color: o,
                scale: r,
                property: l
            }), t.restore(), t.save(), ts(t, n, a.bottom)),
            ss(t, {
                line: i,
                target: n,
                color: s,
    ...
    var rs = {
        ...
        afterDatasetsUpdate(t, e, i) {
            ...
            for (a = 0; a < n; ++a)
                l = o[a],
                l && !1 !== l.fill && (l.fill = Jo(o, a, i.propagate))
        },
        beforeDatasetsDraw(t, e, i) {
            ...
            for (let e = n.length - 1; e >= 0; --e) {
                const s = n[e].$filler;
                s && (s.line.updateControlPoints(o), "beforeDatasetsDraw" === i.drawTime && as(t.ctx, s, o))
            }
        },
        beforeDatasetDraw(t, e, i) {
            const n = e.meta.$filler;
            n && !1 !== n.fill && "beforeDatasetDraw" === i.drawTime && as(t.ctx, n, t.chartArea)
        },
        defaults: {
            propagate: !0,
    ...
    class cs extends Ri {
        ...
        fit()
        {
            ...
            const n = e.labels,
                ...
                {boxWidth: r, itemHeight: l} = ls(n, s);
            let c,
                h;
            i.font = o.string,
        ...
        _draw()
        {
            ...
            a.lineWidth = .5,
            a.font = d.string;
            const {boxWidth: x, boxHeight: b, itemHeight: _} = ls(l, g),
                y = t.isHorizontal(),
            ...
            t.legendItems.forEach(((e, M) => {
                a.strokeStyle = e.fontColor || u,
                a.fillStyle = e.fontColor || u;
                ...
                let D = m.x,
                    C = m.y;
                h.setWidth(t.width),
                y ? M > 0 && D + P + f > t.right && (C = m.y += w, m.line++, D = m.x = o(r, t.left + f, t.right - n[m.line])) : M > 0 && C + w > t.bottom && (D = m.x = D + i[m.line].width + f, m.line++, C = m.y = o(r, t.top + v + f, t.bottom - i[m.line].height));
                !function(t, e, i) {
                    ...
                    if (a.fillStyle = K(i.fillStyle, c), a.lineCap = K(i.lineCap, "butt"), a.lineDashOffset = K(i.lineDashOffset, 0), a.lineJoin = K(i.lineJoin, "miter"), a.lineWidth = n, a.strokeStyle = K(i.strokeStyle, c), a.setLineDash(K(i.lineDash, [])), l.usePointStyle) {
                        ...
                        const o = e + Math.max((g - b) / 2, 0),
                            ...
                            r = Ee(i.borderRadius);
                        a.beginPath(),
                        Object.values(r).some((t => 0 !== t)) ? ee(a, {
                            x: s,
                            y: o,
                            w: x,
                            h: b,
    ...
    class ks extends Ri {
        ...
        getTitle(t, e)
        {
            ...
            let r = [];
            return r = gs(r, ps(o)), r = gs(r, ps(s)), r = gs(r, ps(a)), r
        }
        getBeforeBody(t, e)
        {
            return ws(e.callbacks.beforeBody.apply(this, [t]))
        }
        getBody(t, e)
        {
            const i = this,
            ...
            return J(t, (t => {
                const e = {
                    ...
                    s = Ms(n, t);
                gs(e.before, ps(s.beforeLabel.call(i, t))),
                gs(e.lines, s.label.call(i, t)),
                gs(e.after, ps(s.afterLabel.call(i, t))),
                o.push(e)
            })), o
        }
        getAfterBody(t, e)
        {
            return ws(e.callbacks.afterBody.apply(this, [t]))
        }
        getFooter(t, e)
        {
            const i = this,
        ...
        update(t, e)
        {
            ...
            let s,
                a = [];
            if (o.length) {
                const t = fs[n.position].call(i, o, i._eventPosition);
                a = i._createItems(n),
        ...
        drawTitle(t, e, i)
        {
            ...
            if (s) {
                ...
                for (t.x = vs(n, i.titleAlign, i), e.textAlign = c.textAlign(i.titleAlign), e.textBaseline = "middle", a = Fe(i.titleFont), r = i.titleSpacing, e.fillStyle = i.titleColor, e.font = a.string, l = 0; l < s; ++l)
        ...
        drawBody(t, e, i)
        {
            ...
            let m,
                ...
                v,
                w;
            for (e.textAlign = a, e.textBaseline = "middle", e.font = h.string, t.x = vs(n, p, i), e.fillStyle = i.bodyColor, J(n.beforeBody, g), u = r && "right" !== p ? "center" === a ? c / 2 + 1 : c + 2 : 0, _ = 0, v = o.length; _ < v; ++_) {
        ...
        drawFooter(t, e, i)
        {
            ...
            if (s) {
                ...
                for (t.x = vs(n, i.footerAlign, i), t.y += i.footerMarginTop, e.textAlign = l.textAlign(i.footerAlign), e.textBaseline = "middle", a = Fe(i.footerFont), e.fillStyle = i.footerColor, e.font = a.string, r = 0; r < s; ++r)
        ...
        _updateAnimationTarget(t)
        {
            const e = this,
                ...
                s = n && n.y;
            if (o || s) {
                const n = fs[t.position].call(e, e._active, e._eventPosition);
                if (!n)
                    return;
                const a = e._size = xs(e, t),
        ...
        {
            const i = this,
                n = fs[i.options.position].call(i, t, e);
    ...
    class Cs extends Yi {
        ...
        parse(t, e)
        {
            ...
            return ((t, e) => null === t ? null : Nt(Math.round(t), 0, e))(e = isFinite(e) && i[e] === t ? e : Ds(i, t, K(e, t)), i.length - 1)
        }
        determineDataLimits()
        {
            const t = this,
    ...
    Cs.defaults = {
        ticks: {
            callback: Cs.prototype.getLabelForValue
        }
    };
    class Os extends Yi {
        constructor(t)
        ...
        buildTicks()
        {
            ...
            const o = function(t, e) {
                ...
                x = Math.floor(d / y) * y,
                b = Math.ceil(u / y) * y,
                f && g && n && Tt((s - o) / n, y / 1e3) ? (_ = Math.min((s - o) / y, l), y = (s - o) / _, x = o, b = s) : p ? (x = f ? o : x, b = g ? s : b, _ = r - 1, y = (b - x) / _) : (_ = (b - x) / y, _ = At(_, Math.round(_), y / 1e3) ? Math.round(_) : Math.ceil(_)),
                ...
                for (f && (i.push({
                    value: o
                }), x <= o && v++, At(Math.round((x + v * y) * m) / m, o, y / 10) && v++); v < _; ++v)
                    i.push({
    ...
    class Rs extends Yi {
        ...
        parse(t, e)
        {
            const i = Os.prototype.parse.apply(this, [t, e]);
            if (0 !== i)
    ...
    class Bs extends Os {
        ...
        {
            const e = this;
            Os.prototype.generateTickLabels.call(e, t),
            ...
            e.display && e.pointLabels.display ? function(t) {
                ...
                for (n = 0; n < l; n++) {
                    ...
                    const f = t.getIndexAngle(n),
                        g = Et(f),
                        p = Es(g, s.x, o.w, 0, 180),
                        m = Es(g, s.y, o.h, 90, 270);
        ...
        drawBackground()
        {
            ...
            if (e) {
                ...
                n.save(),
                n.beginPath(),
                zs(t, t.getDistanceFromCenterForValue(t._endValue), i, t.getLabels().length),
                n.closePath(),
                n.fillStyle = e,
                n.fill(),
                n.restore()
    ...
    function $s(t, e, i, n) {
        const o = Ns.length;
        for (let s = Ns.indexOf(t); s < o - 1; ++s) {
            const t = Ws[Ns[s]],
    ...
    class Xs extends Yi {
        ...
        init(t, e)
        {
            const i = t.time || (t.time = {}),
                n = this._adapter = new eo._date(t.adapters.date);
        ...
        buildTicks()
        {
            ...
            const s = t.min,
                a = se(o, s, t.max);
            return t._unit = i.unit || (n.autoSkip ? $s(i.minUnit, t.min, t.max, t._getLabelCapacity(s)) : function(t, e, i, n, o) {
                for (let s = Ns.length - 1; s >= Ns.indexOf(i); s--) {
                    const i = Ns[s];
                    if (Ws[i].common && t._adapter.diff(o, n, i) >= e - 1)
                        return i
                }
                return Ns[i ? Ns.indexOf(i) : 0]
            }(t, a.length, i.minUnit, t.min, t.max)), t._majorUnit = n.major.enabled && "year" !== t._unit ? function(t) {
                for (let e = Ns.indexOf(t) + 1, i = Ns.length; e < i; ++e)
                    if (Ws[Ns[e]].common)
                        return Ns[e]
            }(t._unit) : void 0, t.initOffsets(o), e.reverse && a.reverse(), Us(t, a, t._majorUnit)
        }
        initOffsets(t)
        {
            const e = this;
        ...
        _generate()
        {
            const t = this,
                ...
                o = t.options,
                s = o.time,
                a = s.unit || $s(s.minUnit, i, n, t._getLabelCapacity(i)),
                r = K(s.stepSize, 1),
            ...
            for (d = f, u = 0; d < n; d = +e.add(d, r, a), u++)
                Ys(h, d, g);
            return d !== n && "ticks" !== o.bounds && 1 !== u || Ys(h, d, g), Object.keys(h).sort(((t, e) => t - e)).map((t => +t))
        }
        getLabelForValue(t)
        {
