...
<div class="mt-4">
  ...
  <div class="mt-1">
    <textarea id="description" name="description" rows="3" class="pl-2 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md" placeholder="Decripción de una categoría"></textarea>
  </div>
</div>
@else
<div class="col-span-6 sm:col-span-3 mt-4">
...
<div class="mt-4">
  ...
  Decripción</label>
  <div class="mt-1">
    <textarea id="description" name="description" rows="3" class="pl-2 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md " placeholder="Decripción de una categoría">{{$category->description}}
    </textarea>
  </div>
</div>
@endif