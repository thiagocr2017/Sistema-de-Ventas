<!--Sidebar-->
<div class="w-full px-2 fixed bottom-0 md:w-1/5 md:pt-8 md:top-10 md:left-0 h-16 md:h-full md:border-r-2 text-center md:border-gray-600 bg-gray-900 md:bg-gray-900">
